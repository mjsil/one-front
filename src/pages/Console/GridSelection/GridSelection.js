  ...
  return (
    <div className={styles.container}>
      <div className={styles.GridSelection}>
        ...
        <div className={styles.card} onClick={() => onRedirectHandler('minha-instituicao')}>
          <AccountBalanceOutlinedIcon fontSize="large" className={styles.icon} />
          <h1>Minha Instituição</h1>
        </div>
        <div className={styles.card} onClick={() => onRedirectHandler('instituicoes/mensagem')}>
